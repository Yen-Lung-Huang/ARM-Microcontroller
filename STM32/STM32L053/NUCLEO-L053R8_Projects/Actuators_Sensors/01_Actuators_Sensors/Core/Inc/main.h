...
#define SW_Middle_Up_Pin GPIO_PIN_0
#define SW_Middle_Up_GPIO_Port GPIOC
#define SW_Middle_Up_EXTI_IRQn EXTI0_1_IRQn
#define SW_Middle_Down_Pin GPIO_PIN_1
#define SW_Middle_Down_GPIO_Port GPIOC
#define SW_Middle_Down_EXTI_IRQn EXTI0_1_IRQn
#define SW_Left_Pin GPIO_PIN_2
#define SW_Left_GPIO_Port GPIOC
#define SW_Left_EXTI_IRQn EXTI2_3_IRQn
#define SW_Right_Pin GPIO_PIN_3
#define SW_Right_GPIO_Port GPIOC
#define SW_Right_EXTI_IRQn EXTI2_3_IRQn
...
#define M4_Encoder_A_Pin GPIO_PIN_4
...
#define M4_Encoder_B_GPIO_Port GPIOB
...
#define M3_Encoder_B_Pin GPIO_PIN_10
#define M3_Encoder_B_GPIO_Port GPIOA
...
#define SW_Revolver_Left_Pin GPIO_PIN_15
#define SW_Revolver_Left_GPIO_Port GPIOA
#define SW_Revolver_Left_EXTI_IRQn EXTI4_15_IRQn
...
#define M3_Encoder_A_Pin GPIO_PIN_6
#define M3_Encoder_A_GPIO_Port GPIOB
#define SW_Revolver_Right_Pin GPIO_PIN_7
#define SW_Revolver_Right_GPIO_Port GPIOB
#define SW_Revolver_Right_EXTI_IRQn EXTI4_15_IRQn
#define M2_Encoder_A_Pin GPIO_PIN_8
#define M2_Encoder_A_GPIO_Port GPIOB
#define M2_Encoder_B_Pin GPIO_PIN_9
